var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		canvas.element.style = "position: absolute; top: 0; left: 0; z-index: 9;";
	...
	function canvasSize(canvas){
		...
		canvas.width = 1366+"px" || window.innerWeight || document.documentElement.clientWidth || document.body.clientWidth;
		canvas.height = 483+"px" || window.innerWeight || document.documentElement.clientHeight || document.body.clientHeight;
	}
